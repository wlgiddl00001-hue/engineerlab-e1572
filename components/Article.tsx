...
const faqByCategory:Record<string,[string,string][]>={
 "자격증":[["인강은 필기와 실기를 모두 들어야 하나요?","현재 준비 단계와 보유한 기초에 따라 다릅니다. 필기 합격 전이라면 필기 범위를 우선하고, 실기 준비 단계라면 답안 작성과 기출문제 풀이가 충분한 강좌인지 확인하세요."],["강좌를 고를 때 가장 먼저 볼 기준은 무엇인가요?","교수의 설명 방식, 강좌 범위, 수강기간을 먼저 확인하고 본인의 시험일까지 실제로 복습할 시간이 확보되는지 계산하는 것이 좋습니다."],["할인코드는 언제 확인하면 되나요?","강좌를 결정한 뒤 결제 직전에 e1572 적용 여부와 최종 금액을 확인하세요. 상품과 이벤트 시점에 따라 조건이 달라질 수 있습니다."]],
 ...
 "후기":[["수강후기는 무엇을 중심으로 보면 좋나요?","합격 여부만 보기보다 비전공 여부, 직장 병행, 준비 기간 등 본인과 비슷한 조건의 수험생이 강의를 어떻게 활용했는지 확인하세요."],["후기와 실제 강의 화면을 같이 봐야 하나요?","후기에서 알기 어려운 설명 속도와 판서량은 실제 강의 화면을 함께 보면 판단하기 쉽습니다."],["후기만으로 수강을 결정해도 되나요?","후기는 참고 자료이며 강좌 구성과 가격, 수강기간, 최종 할인 조건까지 직접 확인한 뒤 결정하는 것이 좋습니다."]],
 "할인혜택":[["이 사이트에서 안내하는 할인코드는 무엇인가요?","할인코드는 e1572입니다. 영문 소문자 e와 숫자 1572를 붙여 입력하세요."],["모든 상품에 같은 할인이 적용되나요?","상품과 이벤트 시점에 따라 적용 조건이 달라질 수 있습니다. 결제 전 공식 판매 페이지에서 최종 금액을 확인하세요."],["코드는 언제 입력하는 것이 좋나요?","강좌를 먼저 선택한 뒤 회원가입 또는 결제 과정에서 코드 입력란이 있을 때 e1572를 입력하고 적용 결과를 확인하세요."]],
 "학습가이드":[["하루에 강의를 많이 들으면 진도가 빨라질까요?","영상 시청량보다 문제풀이와 복습까지 끝내는 것이 중요합니다. 하루 분량은 실제 복습 시간을 포함해 정하는 편이 좋습니다."],["기출문제는 언제부터 풀어야 하나요?","기초 개념을 어느 정도 이해한 뒤 가능한 한 일찍 병행하면 출제 방식과 취약 영역을 빠르게 확인할 수 있습니다."],["인강을 고를 때 할인도 중요한가요?","가격은 중요한 비교 요소지만 강좌 범위와 수강기간이 본인의 계획에 맞는지 먼저 확인한 뒤 할인 조건을 비교하는 것이 좋습니다."]]
};
